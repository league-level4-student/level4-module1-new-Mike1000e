...
public class PolymorphWindow extends JPanel implements ActionListener {
   ...
   public static ArrayList<Polymorph> arrayList;
   
   static BluePolymorph bluePoly;
   static RedPolymorph redPoly;
   static MovingMorph MovingPoly;
   
    
    public static void main(String[] args) {
    	arrayList = new ArrayList<Polymorph>();
    	arrayList.add(bluePoly);
    	arrayList.add(redPoly);
    	arrayList.add(MovingPoly);
